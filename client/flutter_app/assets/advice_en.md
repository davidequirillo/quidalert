...
- To prevent the background GPS position tracking from sleeping, you need to go to the 'battery' section of this app settings, and select 'without restrictions'. You can also reach this section from the general settings: Settings -> Applications -> Quidalert -> Battery -> "Without restrictions". 
